    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "devicetype": {
                    ...
                    "add-alias": "Add device alias",
                    "name-starts-with": "Device name starts with",
                    "devicetype-list": "Device Type list",
                    "use-device-name-filter": "Use filter",
                    "device-list-empty": "No devices selected.",
                    "device-name-filter-required": "Device name filter is required.",
                    "device-name-filter-no-device-matched": "No devices starting with '{{device}}' were found.",
                    "add": "Add Device Type",
                    "assign-to-customer": "Assign to customer",
                    "assign-device-to-customer": "Assign Device types(s) To Customer",
                    "assign-device-to-customer-text": "Please select the device types to assign to the customer",
                    "make-public": "Make device type public",
                    "make-private": "Make device type private",
                    "no-devicetypes-text": "No device types found",
                    "assign-to-customer-text": "Please select the customer to assign the device type(s)",
                    "devicetype-details": "Device Type details",
                    "add-devicetype-text": "Add new device type",
                    "credentials": "Credentials",
                    "manage-credentials": "Manage credentials",
                    "delete": "Delete device type",
                    "assign-devices": "Assign device types",
                    "assign-devices-text": "Assign { count, select, 1 {1 device type} other {# device types} } to customer",
                    "delete-devices": "Delete device types",
                    "unassign-from-customer": "Unassign from customer",
                    "unassign-devices": "Unassign device types",
                    "unassign-devices-action-title": "Unassign { count, select, 1 {1 device type} other {# device types} } from customer",
                    "assign-new-device": "Assign new device type",
                    "make-public-device-title": "Are you sure you want to make the device type '{{deviceName}}' public?",
                    "make-public-device-text": "After the confirmation the device type will be made public and accessible by others.",
                    "make-private-device-title": "Are you sure you want to make the device type '{{deviceName}}' private?",
                    "make-private-device-text": "After the confirmation the device type will be made private and won't be accessible by others.",
                    "view-credentials": "View credentials",
                    "delete-device-title": "Are you sure you want to delete the device type '{{deviceName}}'?",
                    "delete-device-text": "Be careful, after the confirmation the device type will become unrecoverable.",
                    "delete-devices-title": "Are you sure you want to delete { count, select, 1 {1 device type} other {# device types} }?",
                    "delete-devices-action-title": "Delete { count, select, 1 {1 device type} other {# device types} }",
                    "delete-devices-text": "Be careful, after the confirmation all selected device types will be removed and become unrecoverable.",
                    "unassign-device-title": "Are you sure you want to unassign the device type '{{deviceName}}'?",
                    "unassign-device-text": "After the confirmation the device type will be unassigned and won't be accessible by the customer.",
                    "unassign-device": "Unassign device type",
                    "unassign-devices-title": "Are you sure you want to unassign { count, select, 1 {1 device type} other {# device types} }?",
                    "unassign-devices-text": "After the confirmation all selected device types will be unassigned and won't be accessible by the customer.",
                    "device-credentials": "Device Credentials",
                    "credentials-type": "Credentials type",
                    "access-token": "Access token",
                    "access-token-required": "Access token is required.",
