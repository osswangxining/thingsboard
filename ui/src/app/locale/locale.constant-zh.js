...
export default function addLocaleChinese(locales) {
    var zh_CN = {
        ...
        "asset": {
            ...
            "no-assets-text": "找不到资产",
            "assign-to-customer-text": "请选择客户分配资产",
            "public": "公共",
            ...
            "asset-public": "资产是公共的",
            "asset-type": "资产类型",
            "asset-type-required": "资产类型是必需的。",
            "select-asset-type": "选择资产类型",
            "enter-asset-type": "输入资产类型",
            "any-asset": "任意资产",
            "no-asset-types-matching": "找不到与 '{{entity}}' 匹配的资产类型。",
            "asset-type-list-empty": "没有被选中的资产类型",
            "asset-types": "资产类型",
            "name": "名称",
            ...
            "asset-details": "资产明细",
            "assign-assets": "分配资产",
            "assign-assets-text": "将{count,select,1 {1 asset} other {# assets}}分配给客户",
            "delete-assets": "删除资产",
            "unassign-assets": "取消分配资产",
            "unassign-assets-action-title": "取消分配{count,select,1 {1 asset} other {# assets}}",
            "assign-new-asset": "分配新资产",
            "delete-asset-title": "您确定要删除资产{{assetName}}吗？",
            "delete-asset-text": "小心！确认后设备及其所有相关数据将不可恢复。",
            "delete-assets-title": "您确定要删除{count,select,1 {1 asset} other {# assets}} 吗？",
            "delete-assets-action-title": "删除 {count,select,1 {1 asset} other {# assets}}",
            "delete-assets-text": "小心！确认后所有选定的资产将被删除,所有相关数据将不可恢复。",
            "make-public-asset-title": "您确定要将资产 '{{assetName}}' 设为公开吗？",
            "make-public-asset-text": "确认后，资产及其所有数据将被公开并可被其他人访问。",
            "make-private-asset-title": "您确定要将资产 '{{assetName}}' 设为私有吗？",
            "make-private-asset-text": "确认后，资产及其所有数据将被私有化，不被其他人访问。",
            "unassign-asset-title": "您确定要取消分配资产 '{{assetName}}'？",
            "unassign-asset-text": "确认后,资产将被取消分配,客户将无法访问。",
            "unassign-asset": "取消分配资产",
            "unassign-assets-title": "您确定要取消分配{count,select,1 {1 asset} other {# assets}} 吗？",
            "unassign-assets-text": "确认后,所有选定的资产将被取消分配,并且客户将无法访问。",
            "copyId": "复制资产ID",
            "copyAccessToken": "复制访问令牌",
            "idCopiedMessage": "设备ID已复制到剪贴板",
            "accessTokenCopiedMessage": "设备访问令牌已复制到剪贴板",
            "select-asset": "选择资产",
            "no-assets-matching": "找不到与 '{{entity}}' 匹配的资产。",
            "asset-required": "资产是必需的",
            "name-starts-with": "名称前缀",
            "asset-credentials": "资产凭据",
