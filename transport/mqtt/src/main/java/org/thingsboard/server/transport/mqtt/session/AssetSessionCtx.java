...
import org.thingsboard.server.common.transport.session.AssetAwareSessionContext;
 ...
 */
@Slf4j
public class AssetSessionCtx extends AssetAwareSessionContext {
    ...
    public AssetSessionCtx(SessionMsgProcessor processor, AssetAuthService authService, MqttTransportAdaptor adaptor) {
